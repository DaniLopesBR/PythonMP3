...
def repetir_musica():
    ...
    if pygame.mixer.music.get_busy():
        ...
        button_repeat.config(bg="#b2dafb")
...
def repetir_todas():
    ...
    if pygame.mixer.music.get_busy():
        ...
        button_repeat_all.config(bg="#b2dafb")
...
def reproducao_aleatoria():
    ...
    if pygame.mixer.music.get_busy():
        ...
        button_random.config(bg="#b2dafb")
...
def main():
    ...
    global play_icon, pause_icon, button_pause_play, continue_icon, stop_icon, repeat_icon, button_repeat, button_repeat_all, button_random  # Variáveis globais para os ícones de play, pause e stop, e os botões correspondentes
    ...
    button_repeat.grid(row=7, column=2)  # Botão para repetir a música atual
    button_repeat_all.grid(row=9, column=0)  # Botão para repetir todas as músicas
    button_random.grid(row=9, column=2)  # Botão para reprodução aleatória
    ...
    footer_label.grid(row=10, column=0, columnspan=5)
