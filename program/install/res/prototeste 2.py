...
button_repeat = None  # Variável para o botão de repetir
...
def repetir_todas():
    global button_repeat, resultados
    pygame.mixer.music.set_endevent(pygame.USEREVENT)
    if pygame.mixer.music.get_busy():
        for musica in resultados:
            pygame.mixer.music.queue(musica)  # Adiciona cada música na fila de reprodução
        button_repeat.config(bg="#001dff")  # Altera a cor do botão de repetir
    else:
        button_repeat.config(bg="#b2dafb")  # Retorna a cor original do botão de repetir
...
# Função principal
def main():
    global current_song_label, button_repeat  # Definindo current_song_label e button_repeat como global
    ...
    button_repeat_all = tk.Button(root, text="Repetir Todas", command=repetir_todas, bg="#b2dafb", fg="#000000")
